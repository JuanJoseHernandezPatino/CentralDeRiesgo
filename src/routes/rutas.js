...
//graficos
//jj
router.post('/grafico1', rutas_.grafico1);

//maria 
//grafico cohortes
router.post('/listadocohortes', rutas_.selecioncohorte) //para selecionar la cohorte 
router.post('/listacohortes', rutas_.cargar) //mostrar las cohortes traidas de la base de datos
router.get('/tablaCompletaAfiliados', rutas_.datosAfiliados) //mostrar las cohortes traidas de la base de datos
router.get('/graficoCohortes', rutas_.graficoCohortes) 
